...
public class PerformanceBasedAssignment implements AssignmentStrategy {
    @Override
    public List<Task> assignTasks(List<Moderator> moderators, List<Task> task, AssignmentFilters filters) {
        ...
        moderators.sort((m1, m2) -> Integer.compare(m2.getPerformanceScore(), m1.getPerformanceScore()));
